  ...
  Mutation: {
    ...
    async login(_, { uid }) {
      ...
      try {
        ...
        //         // console.log(list);
        //     const { email } = list
        // const logIn = await firebase.auth().signInWithEmailAndPassword(email, password); - This method is not available on firebase-admin
        //console.log(logIn);
    ...
    async registerUser(_, args, content, info) {
      ...
      let newUser = {
        ...
        createdAt: new Date().toISOString(),
        profilePicture:
          "https://firebasestorage.googleapis.com/v0/b/insvire-curious-app12.appspot.com/o/Profile%20Default.png?alt=media&token=64b822ce-e1c7-4f6b-9dfd-f02a830fe942",
      };
